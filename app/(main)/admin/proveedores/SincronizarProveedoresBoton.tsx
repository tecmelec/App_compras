...
import { sincronizarProveedoresBC } from '@/app/actions/business-central';

export default function SincronizarProveedoresBoton() {
  ...
  async function handleSincronizar() {
    ...
    const r = await sincronizarProveedoresBC();
    ...
    setResultado(
      `${r.creados} proveedor(es) nuevo(s), ${r.actualizados} actualizado(s) de ${r.totalBC} en Business Central.` +
