...
-- Nadie necesita leer/escribir esta tabla directamente: solo la usa la
-- función de abajo (con SECURITY DEFINER, así que sigue funcionando
-- aunque no haya ninguna política para clientes anon/authenticated).
